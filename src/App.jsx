...
export default function App() {
  ...
  return (
    <div id="top" className="bg-gray-50 text-gray-800 font-sans relative">
      {/* ================
          HEADER
      ================ */}
        ...
        {mobileMenuOpen && (
          <nav className="lg:hidden bg-white border-t border-gray-200">
            <div className="max-w-7xl mx-auto px-4 py-2 flex flex-col space-y-2">
              ...
              <a
                href="#testimonios"
                className="px-4 py-2 bg-gray-100 rounded hover:bg-orange-500 hover:text-white transición text-sm"
                onClick={() => setMobileMenuOpen(false)}
              >
                {t.testimonials}
              </a>
      ...
      <section className="py-16 text-center">
        <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-6">
          ...
          <div className="p-6 bg-gray-200 rounded-lg shadow">
            ...
            <p className="text-gray-700">{t.goalsText}</p>
          </div>
        </div>
      </section>
      ...
      {/* ================
          NUESTROS SERVICIOS (Swiper Carrusel 3D)
      ================ */}
      <main className="max-w-6xl mx-auto px-4 py-16" id="servicios">
        <h3 className="section-title">{t.ourServices}</h3>
        <Swiper
        ...
        >
          {services.map((service, i) => (
            <SwiperSlide key={i} className="swiper-slide">
              <Tilt className="tilt-wrapper" tiltMaxAngleX={8} tiltMaxAngleY={8}>
                <div className="card-3d w-full h-full" onClick={() => setSelectedService(service)}>
                  <img
                    src={service.image}
                  ...
                  <div className="p-4 text-center">
                    <h4 className="text-lg font-semibold">{service.title[lang]}</h4>
                  </div>
                </div>
              </Tilt>
            </SwiperSlide>
          ...
          <SwiperSlide className="swiper-slide">
            <div className="card-3d w-full h-full">
              ...
              />
              <div className="p-4 text-center">
                <h4 className="text-lg font-semibold">{t.promoTitle}</h4>
                <p className="text-gray-700">{t.promoText}</p>
              </div>
            </div>
          </SwiperSlide>
        </Swiper>
      ...
      ================ */}
      <section id="cotizacion" className="py-16 bg-gray-100">
      ...
      {/* ================
          TESTIMONIOS
      ================ */}
      <section id="testimonios" className="py-16 bg-gray-100 text-center">
        <h3 className="section-title">{t.testimonialsTitle}</h3>
        <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-6">
